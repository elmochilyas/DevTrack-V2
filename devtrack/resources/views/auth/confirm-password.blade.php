<x-guest-layout>
    <div class="mb-8">
        <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Confirm your password</h2>
        <p class="mt-2 text-gray-500 text-sm">This is a secure area. Please confirm your password to continue.</p>
    </div>
        ...
        <div x-data="{ show: false }">
            ...
            <div class="relative">
                ...
                <input id="password" :type="show ? 'text' : 'password'" name="password" required
                       ...
                       class="input-modern pl-11 pr-11" placeholder="Enter your password">
