<x-guest-layout>
    <div class="mb-8">
        ...
        <p class="text-gray-500 mt-2 text-sm">Start managing your projects in minutes</p>
    </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                       autocomplete="name"
                       class="input-modern pl-11" placeholder="John Doe">
            </div>
        ...
        <div x-data="{ show: false }">
            ...
            <div class="relative">
                ...
                <input id="password" :type="show ? 'text' : 'password'" name="password" required
                       ...
                       class="input-modern pl-11 pr-11" placeholder="Min. 8 characters">
        ...
        <div x-data="{ show: false }">
            ...
            <div class="relative">
                ...
                <input id="password_confirmation" :type="show ? 'text' : 'password'" name="password_confirmation" required
                       autocomplete="new-password"
                       class="input-modern pl-11 pr-11" placeholder="Repeat your password">
                <button type="button" @click="show = !show"
                        class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-400 hover:text-gray-600 transition-colors"
                        :aria-label="show ? 'Hide password' : 'Show password'">
                    <svg x-show="!show" class="h-4.5 w-4.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
