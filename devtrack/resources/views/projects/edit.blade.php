<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <a href="{{ route('projects.show', $project) }}" class="w-10 h-10 bg-gray-100 hover:bg-gray-200 rounded-xl flex items-center justify-center transition-colors group">
            ...
            <div>
                <h2 class="font-bold text-2xl text-gray-900 leading-tight">Edit Project</h2>
